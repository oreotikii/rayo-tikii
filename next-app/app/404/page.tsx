...
export default function Page() {
  ...
  return (
    <>
      <div className="mxd-floating-img floating-bg mxd-error-artwork">
        <div className="mxd-floating-img__item mxd-move">
          <img src="/img/tikii/23.png" alt="Tikii 404 artwork" />
        </div>
      </div>
      <main id="mxd-page-content" className="mxd-page-content mxd-error-page">
              ...
              <div className="mxd-error floating-cards">
                ...
                <div className="mxd-error__controls loading__fade">
                  <div className="container-fluid p-0">
                    <div className="row g-0">
                      <div className="col-12 col-xl-6 mxd-grid-item no-margin">
                        <a className="btn btn-anim btn-default btn-accent slide-right-up" href="/">
